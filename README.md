...
set PHOTO_POST_DAVINCI_CMD=python scripts\davinci_bridge.py
```

```bash
set PHOTO_POST_EDITOR=davinci
set PHOTO_POST_DAVINCI_INPUT_MODE=file
set PHOTO_POST_DAVINCI_CMD=python scripts\davinci_bridge.py --payload "{payload_path}"
```
