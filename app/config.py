...
class Settings(BaseModel):
    ...
    default_davinci_cmd: str | None = "py -3 scripts/davinci_bridge.py --mode auto"
...
def get_settings() -> Settings:
    return Settings(
        ...
        default_davinci_cmd=os.getenv("PHOTO_POST_DAVINCI_CMD", "py -3 scripts/davinci_bridge.py --mode auto"),
